...
describe('Tutorial page', () => {
  ...
  it('has an iframe centered in a big viewport', () => testCentered({ width: 1920, height: 1080 }));

  it('has an iframe centered in a small viewport', () => testCentered({ width: 320, height: 570 }));
});
