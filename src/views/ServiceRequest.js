...
class ServiceRequest extends Component {
  constructor(props) {
    ...
    this.leftCheckboxes = ['Simple1', 'Simple2', 'Simple3', 'Simple4', 'Simple5', 'Simple6'];
    this.rightCheckboxes = ['Simple7', 'Simple8', 'Simple9', 'Simple10', 'Simple11', 'Simple12'];
    const stringProps = [...this.singleLineFields, ...this.multiLineFields].reduce(
      (acc, label) => ({
    ...
    const checkboxProps = [...this.leftCheckboxes, ...this.rightCheckboxes].reduce(
      (acc, label) => ({
  ...
  handleFormData = async () => {
    ...
    try {
      ...
      const msg = typeof err === 'string' ? err : 'An error occurred while sending the request.';
      this.setState({
        resultDialogOpen: true,
    ...
    return (
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col s12 m6">
            {this.rightCheckboxes.map((label, index) => CheckboxField(label, index))}
          </div>
          <div className="col s12">
            <RaisedButton label="Submit" id="submit-button" onClick={this.handleFormData} primary />
        ...
        <Dialog
          ...
          actions={[<FlatButton label="Ok" onTouchTap={this.handleDialogClose} keyboardFocused />]}
        >
