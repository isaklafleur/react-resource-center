...
const ENABLE_SEND_EMAILS = process.env.NODE_ENV === 'production' || process.env.ENABLE_SEND_EMAILS;
      ...
      wrikeMkFolder(fields['email'], fieldsString)
        .then(status => {
          ...
          for (const file of files) {
            ...
            wrikeAddAttachment(folderId, readStream, file.name, file.type).catch(err => {
